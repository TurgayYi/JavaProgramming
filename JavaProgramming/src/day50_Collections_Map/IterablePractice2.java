...
public class IterablePractice2 {
    ...
    public static void main(String[] args) {
        ...
        names.addAll(Arrays.asList("Ahmed","ahmed","aHmEd","John","Daniel","Mustafa","Mohammed","ahmed","Yulia","Chris"));
        ...
        while (it.hasNext()){
            ...
            if(it.next().toLowerCase().equals("ahmed")){
                it.remove();
            }
        ...
        names2.addAll(Arrays.asList("Ahmed","ahmed","aHmEd","John","Daniel","Mustafa","Mohammed","ahmed","Yulia","Chris"));
        ...
        names3.addAll(Arrays.asList("Ahmed","ahmed","aHmEd","John","Daniel","Mustafa","Mohammed","ahmed","Yulia","Chris"));
