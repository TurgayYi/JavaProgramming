...
public class PolymorphismPractice2 {
    ...
    public static void main(String[] args) {
        ...
        for (Employee scrumMember : scrumMembers) {
            if (scrumMember instanceof Developer && scrumMember.getSalary() > developerWithMaxSalary.getSalary()){
                developerWithMaxSalary = (Developer) scrumMember;
            }

            if (scrumMember instanceof Tester && scrumMember.getSalary() > testerWithMaxSalary.getSalary()){
                testerWithMaxSalary = (Tester) scrumMember;
            }
