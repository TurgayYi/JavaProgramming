...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer3.setInfo("FL","Apple Inc","QA",
                95000, true,true,true,false);

        Offer offer4 = new Offer();
        offer4.setInfo("TX","CapitalOne","SM",
                99000, false,false,true,true);


        Offer offer5 = new Offer();
        offer5.setInfo("WA","Bank Of America","BA",
                130000, true,true,false,true);

        Offer offer6 = new Offer();
        offer6.setInfo("OH","Microsoft Inc","QA",
                91000,false,true,true,true);

        Offer offer7 = new Offer();
        offer7.setInfo("NJ","99 Trading","SDET",
                122200,true,true,false,true);
        ...
        2.7 Create an ArrayList of Offer named offersWith100K and add all the offer objects.
						2.7.1 Write a program that can remove all the offers that are offering less
						than 100K salary
         */
