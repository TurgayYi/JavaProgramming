...
public class MethodOverLoadedIntro {

    public static void main(String[] args) {

        int[] intArray ={5,6,-4,3,2};
        ...
        int sum1= sumOfNumbers(1,3,4);
        int sum2 = sumOfNumbers(1,2,3,4);
        double sum3 = sumOfNumbers(1.3,2.4,5.5);
        double sum4 = sumOfNumbers(1.1,2.1,32.3,44.4);
