...
public class ReplaceAll {
    ...
    //replaces all the matching old values of the array with the given new value, and returns the new array.
...
/*
2. RecplaceAll Task:
		2.1 Create a method named replaceAll that passes three parameters: integer array,
